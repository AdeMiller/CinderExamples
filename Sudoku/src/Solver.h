...
struct cell {
    ...
    cell() : val(0), locked(false), mask(0b0000000111111111) {}

    cell(unsigned char v) : val(v), locked(v != 0), mask(0b0000000111111111)
    {
        if (v)
            mask = 0b0000000111111111 & (0b0000001000000000 >> (10 - v));
    }
};
